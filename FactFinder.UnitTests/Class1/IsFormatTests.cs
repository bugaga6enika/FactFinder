...
using TestClass = FactFinder.Class1;

namespace FactFinder.UnitTests.Class1
{
    public class IsFormatTests
    {
        ...
        [InlineData("")]
        [InlineData(null)]
        public void Given_NullOrEmpty_str_Should_Throw_ArgumentException(string str)
        {
            // Act
        ...
        [InlineData("")]
        [InlineData(null)]
        public void Given_NullOrEmpty_f_Should_Throw_ArgumentException(string f)
        {
            // Act
        ...
        [Fact]
        public void Given_Invalid_f_Should_Throw_Exception_With_Message_Format_Not_Allowed()
        {
            // Act
            var act = () => TestClass.IsFormat("0", "bool");

            // Assert
            act.Should().Throw<Exception>().WithMessage("Format not allowed.");
        }
        ...
        [InlineData("256.56", "NuMbEr")]
        [InlineData("-342342.432432", "numBEr")]
        public void Given_Valid_Number_As_str_Returns_True(string str, string f)
        {
            // Arrange and Act
        ...
        [InlineData("4sdfsdf", "NuMbEr")]
        [InlineData("-342342.4r2432", "numBEr")]
        public void Given_Invalid_Number_As_str_Returns_False(string str, string f)
        {
            // Arrange and Act
            var result = TestClass.IsFormat(str, f);
        ...
        [InlineData("Feb 16, 1978", "DATE")]
        public void Given_Valid_Date_As_str_Returns_True(string str, string f)
        {   
            // Arrange and Act
            var result = TestClass.IsFormat(str, f);
        ...
        [InlineData("2:45:22", "tiMESPan")]
        [InlineData("-02:15:59", "TiMeSpAn")]
        public void Given_Valid_TimeSpan_As_str_Returns_True(string str, string f)
        {
            // Arrange and Act
            var result = TestClass.IsFormat(str, f);
        ...
        [InlineData("17.", "tiMeSPAn")]
        [InlineData("2 pm", "tiMESPan")]
        public void Given_Invalid_TimeSpan_As_str_Returns_False(string str, string f)
        {
            // Arrange and Act
            var result = TestClass.IsFormat(str, f);
