...
namespace FactFinder.UnitTests.StringFormatValidatorExt
{
    public class IsFormatTests
    {
        private readonly FactFinder.StringFormatValidatorExt _stringFormatValidatorExt;
        public IsFormatTests()
        {
            ...
            _stringFormatValidatorExt = new FactFinder.StringFormatValidatorExt(new Dictionary<string, Func<string, bool>>
            {
        ...
        {
            // Act
            var act = () => _stringFormatValidatorExt.IsFormat(str, "date");
        ...
        {
            // Act
            var act = () => _stringFormatValidatorExt.IsFormat("0", f);
        ...
        {
            // Act
            var act = () => _stringFormatValidatorExt.IsFormat("0", "bool");
        ...
        {
            // Arrange and Act
            var result = _stringFormatValidatorExt.IsFormat(str, f);
